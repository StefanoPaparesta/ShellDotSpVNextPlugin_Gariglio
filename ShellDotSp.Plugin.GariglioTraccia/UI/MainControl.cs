...
{
    public partial class MainControlGariglioTraccia : UserControl, IMainView
    {
        ...
        #region Ctor
        public MainControlGariglioTraccia()
        {
            InitializeComponent();
        ...
        private void CaricaView(string Name)
        {
            ...
            string typeName = $"ShellDotSp.Plugin.GariglioTraccia.View.{Name}";
