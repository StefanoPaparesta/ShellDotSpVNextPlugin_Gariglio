...
using ShellDotSp.Plugin.GariglioUscitaMerci.Forms;
...
{
    public partial class MainControlGariglioUscita : UserControl, IMainView
    {
        ...
        #region Ctor
        public MainControlGariglioUscita()
        {
            InitializeComponent();
        ...
        public void UpdateUI(Function functionName)
        {
            ...
            switch (functionName)
            {
                case Function.ElencoDocumenti:
                    ...
                    bndTipoDoc.DataSource = Presenter.TipoDocumenti;
                    break;
        ...
        private void btnAggiungi_Click(object sender, EventArgs e)
        {
            ...
            using (FrmUscitaMerci Frm = new FrmUscitaMerci(Presenter))
            {
