...
{
    public partial class FrmUscitaMerci : Form
    {

        #region Ctor
        public FrmUscitaMerci(MainPresenter Presenter)
        {
            InitializeComponent();
        ...
        private void FrmIngressoMerci_Load(object sender, System.EventArgs e)
        {
            ...
            Presenter.LoadAnagrafiche("C");
            Presenter.LoadArticoli();

            bndClienti.DataSource = Presenter.Clienti;
            bndArticoli.DataSource = Presenter.Articoli;
            bndTipoDoc.DataSource = new TipoDocumentoCollection();

            lkTipoDocumento.EditValue = "DDT";
            ...
            else
            {
                ...
                lkTipoDocumento.EditValue = Presenter.DocumentoSelezionato.TipoDocumento;
        ...
        private void btnOK_Click(object sender, System.EventArgs e)
        {
            ...
            if (ErrorMessages.Count == 0)
            {
                ...
                Documento.Tipo = lkTipoDocumento.EditValue.ToString();
        ...
        private void btnAggiungiArticolo_Click(object sender, System.EventArgs e)
        {
            ...
            bool response = false;
            bool responseLotto = false;

            if (!Presenter.VerificaLottoConf(txLotto.Text))
            {

                if (MessageBox.Show("Il lotto non è un lotto di confezionamento, proseguo ?",
                                  "Gariglio",
            ...
            if (num >= 1)
            {
                ...
                if (MessageBox.Show("Articolo già presente, lo carico coumnque ?",
                                    "Gariglio",
                                    MessageBoxButtons.YesNo,
                                    MessageBoxIcon.Error) == DialogResult.Yes)
                {
